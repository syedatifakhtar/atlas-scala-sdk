...
case class JsonAtlasRelationshipDef (
  ...
  endDef1: Option[JsonAtlasRelationshipEndDef] = None,
  endDef2: Option[JsonAtlasRelationshipEndDef] = None,
  propagateTags: Option[JsonPropagateTags] = None,
  relationshipCategory: Option[JsonRelationshipCategory] = None,
  // 
  relationshipLabel: Option[String] = None
)
